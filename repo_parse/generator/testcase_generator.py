...
class JavaTestcaseGenerator(TestcaseGenerator):
    ...
    def refined_generate_testcases(self, method: Dict, save: bool = True):
        ...
        try:
            ...
            generated_class_name, results, error = self.call_llm_to_generate(system_prompt, user_input, method, class_name, target_method, save=save)
